...
def frame_tick(frame_width = 2, tick_width = 1.5):
    '''
    Parameters:
        frame_width: New thickness of axes, default: 2
        tick_width: New thickness of axes ticks, default: 1.5
    returns: None
    '''
    ax = gca()
...
def legend(location = 'best', fontsize = 8):
    '''
    Wrapper for plt.legend() command for custom legend properties
    Parameters:
        location: Location of legend, default: "best"
        fontsize: Font size of legend text, default: 8
    returns: None
    '''
